  ...
  render() {
    return  <div className="title clearfix">
                ...
                <div id="hotplayMenu" className="filmlink fl __r_c_" pan="M14_TheaterIndex_HotplayMenu">
                    <a href="#" className="on" onClick="return false;">全部<span>|</span></a>
                    <a href="#" onClick="return false;">3D<span>|</span></a>
                    <a href="#" onClick="return false;" className="">IMAX<span>|</span></a>
                    <a href="#" onClick="return false;" className="">喜剧<span>|</span></a>
                    <a href="#" onClick="return false;" className="">动作<span>|</span></a>
                    <a href="#" onClick="return false;" className="">冒险<span>|</span></a>
                    <a href="#" onClick="return false;" className="">爱情<span>|</span></a>
                    <a href="#" onClick="return false;" className="">悬疑</a>
                </div>
                <div className="citysearch __r_c_" pan="M14_TheaterIndex_HotplaySearch">
                    <input id="hotplaySearchText" type="text" className="text c_a5" value="搜索影片" autoComplete="off"></input>
